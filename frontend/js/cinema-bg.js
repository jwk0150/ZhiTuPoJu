...
(function () {
  ...
  style.textContent = [
    ...
    'body[data-page="map"] .graph-detail .detail-name,body[data-page="map"] .graph-detail h2,body[data-page="map"] .graph-detail h3,body[data-page="map"] .graph-detail h4,body[data-page="map"] #talent-hover-name,body[data-page="map"] .graph-detail .tech-detail-name{color:#1A1A1A !important;}',
    ...
    'body[data-page="map"] .graph-detail .tech-detail-section-title,body[data-page="map"] .graph-detail .graph-btn{color:#5C4A28 !important;}',
    'body[data-page="map"] .graph-detail .tech-detail-text,body[data-page="map"] .graph-detail .tech-detail-stat-label{color:#374151 !important;}',
    'body[data-page="map"] .graph-detail .tech-detail-tag{color:#5C4A28 !important;background:rgba(168,139,78,.12) !important;border-color:rgba(168,139,78,.35) !important;}',
    ...
    'body[data-page="map"] .talent-map-lead{display:block !important;color:#374151 !important;margin:10px 0 0;max-width:46rem;font-size:14px;line-height:1.65;}',
    'body[data-page="map"] .talent-map-lead[hidden]{display:none !important;}',
