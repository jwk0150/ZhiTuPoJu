...
(function () {
  ...
  style.textContent = [
    ...
    '.card,.kpi-card,.job-card,.graph-filter,.match-resume,.match-job-card,.evo-list,.evo-stat,.source-card,.quality-card,.proto-stat,.proto-banner,.header,.icon-btn,.btn,.btn-ghost,.module-card,.home-quick,.home-panel{background:rgba(12,16,24,0.72) !important;border:1px solid rgba(255,255,255,0.12) !important;backdrop-filter:blur(8px);-webkit-backdrop-filter:blur(8px);}',
    '.graph-detail{background:#FAF3E2 !important;border:1px solid rgba(184,134,11,.35) !important;backdrop-filter:blur(18px);-webkit-backdrop-filter:blur(18px);box-shadow:0 18px 44px rgba(120,90,20,.18) !important;color:#3A2E0E !important}',
    '.graph-detail .btn{background:rgba(212,175,55,.14) !important;border:1px solid rgba(212,175,55,.4) !important;color:#8F6B0E !important;}',
    ...
    '.graph-canvas.canvas-panel{background:rgba(16,185,129,0.10) !important;backdrop-filter:blur(8px);-webkit-backdrop-filter:blur(8px);border-color:rgba(16,185,129,0.30) !important;box-shadow:0 8px 32px rgba(2,8,16,0.18) !important;}',
