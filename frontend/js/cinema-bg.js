...
(function () {
  ...
  style.textContent = [
    ...
    '.cinema-bg-orb.is-a{width:42vw;height:42vw;left:-8vw;top:18vh;background:rgba(201,168,106,.10);}',
    '.cinema-bg-orb.is-b{width:36vw;height:36vw;right:-6vw;bottom:8vh;background:rgba(70,130,118,.16);}',
    ...
    'body[data-page="map"] .graph-filter-float-panel{background:rgba(16,28,25,0.9) !important;border:1px solid rgba(201,168,106,0.28) !important;backdrop-filter:blur(14px);-webkit-backdrop-filter:blur(14px);}',
    ...
    'body[data-page="map"] .graph-detail{background-color:#132420 !important;background-image:linear-gradient(165deg,rgba(26,44,39,.96),rgba(16,28,25,.98)) !important;border:1px solid rgba(201,168,106,.28) !important;backdrop-filter:blur(18px);-webkit-backdrop-filter:blur(18px);box-shadow:0 18px 44px rgba(0,0,0,.36),inset 0 1px 0 rgba(228,207,160,.06) !important;color:#d5e0db !important}',
    'body[data-page="map"] .graph-detail .btn{background:rgba(201,168,106,.12) !important;border:1px solid rgba(201,168,106,.36) !important;color:#e4cfa0 !important;}',
    'body[data-page="map"] .graph-detail .detail-name,body[data-page="map"] .graph-detail h2,body[data-page="map"] .graph-detail h3,body[data-page="map"] .graph-detail h4{color:#e2ebe7 !important}',
    'body[data-page="map"] .graph-detail .detail-cat,body[data-page="map"] .graph-detail .detail-empty p,body[data-page="map"] .graph-detail .detail-stat-label,body[data-page="map"] .graph-detail .detail-section-title{color:#9aada5 !important}',
    'body[data-page="map"] .graph-detail .detail-stat-value{color:#e4cfa0 !important}',
    'body[data-page="map"] .graph-detail .detail-stat,body[data-page="map"] .graph-detail .detail-rel-item{background:rgba(255,255,255,.05) !important}',
    'body[data-page="map"] .graph-detail .detail-header{border-bottom-color:rgba(255,255,255,.1) !important}',
    'body[data-page="map"] #talent-detail-hover{color:#d5e0db}',
    'body[data-page="map"] #talent-hover-name{color:#e4cfa0 !important}',
    'body[data-page="map"] .graph-legend{background:rgba(16,28,25,.86) !important;backdrop-filter:blur(10px) !important;-webkit-backdrop-filter:blur(10px) !important;border:1px solid rgba(201,168,106,.28) !important;border-radius:10px !important;color:rgba(232,235,220,.9) !important;box-shadow:0 6px 20px rgba(0,0,0,.25) !important;}',
    'body[data-page="map"] .graph-stats{background:rgba(16,28,25,.88) !important;backdrop-filter:blur(10px) !important;-webkit-backdrop-filter:blur(10px) !important;border:1px solid rgba(201,168,106,.22) !important;border-radius:10px !important;color:#d5e0db !important;}',
    ...
    'body[data-page="map"] .graph-canvas.canvas-panel{background:rgba(16,28,25,.42) !important;backdrop-filter:blur(12px) !important;-webkit-backdrop-filter:blur(12px) !important;border:1px solid rgba(201,168,106,.26) !important;box-shadow:0 8px 32px rgba(0,0,0,.24) !important;}',
