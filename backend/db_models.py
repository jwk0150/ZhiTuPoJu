...
class JobPostingDetail(Base):
    ...
    job_category_l1: Mapped[Optional[str]] = mapped_column(String(64))
    job_category_l2: Mapped[Optional[str]] = mapped_column(String(64))
    job_category_l3: Mapped[Optional[str]] = mapped_column(String(64))
    ...
    contact_wechat: Mapped[Optional[str]] = mapped_column(String(64))
    resume_receive_email: Mapped[Optional[str]] = mapped_column(String(128))
    ...
    interview_count: Mapped[Optional[int]] = mapped_column(Integer)
    hire_count: Mapped[Optional[int]] = mapped_column(Integer)
    view_count: Mapped[Optional[int]] = mapped_column(Integer)
    apply_count: Mapped[Optional[int]] = mapped_column(Integer)
    favor_count: Mapped[Optional[int]] = mapped_column(Integer)
